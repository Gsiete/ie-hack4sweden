...
const Map = () => {
  ...
  const addInteraction = () => {
    console.log('innerHTML', typeSelect?.innerHTML)
    console.log('value', typeSelect?.value)
    var type = typeSelect?.value == 'area' ? GeometryType.POLYGON : GeometryType.LINE_STRING;
    draw = new Draw({
      source: vectorSource,
      type: type,
      style: new Style({
